...
import { buildFullUrl, waitForLoadingToComplete, waitForNavigation } from '../helpers/wait';
...
test.describe('設定フロー', () => {
  ...
  test('プロフィール編集', async ({ page }) => {
    ...
    const profileLink = page.locator('button:has-text("編集"), a[href*="profile-edit"]').first();
